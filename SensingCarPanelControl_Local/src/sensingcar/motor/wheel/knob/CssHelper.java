...
public class CssHelper {
    ...
    /**
     * Creates a List of CssMetaData instances that is merged by the given
     * parameters
     *
     * @param baseList A basic list. All elements of the list will be in the
     * returned list
     * @param metaData An array of CssMetaData instances. All instances will be
    ...
    /**
     * Creates a StyleableObjectProperty instance that is parametrized by the
     * given parameters. The returned property must be defined as a field in the
     * given Styleable class. The property will be a
     * <tt>SimpleStyleableObjectProperty</tt>
     *
     * @param metaData The CssMetaData instance
     * @param styleable The styleable that contains the property field. Mostly
     * this will be a JavaFX Control class
     * @param <S> Type of the Styleable
     * @param <V> value type of the property
     * @return a styleable property that can be used in a Styleable class like a
     * Control
     *
    ...
    /**
     * Creates a StyleableObjectProperty instance that is parametrized by the
     * given parameters. The property will be a
     * <tt>SimpleStyleableObjectProperty</tt>. The returned property must be
     * defined as a field in the Skin class of the given Control class.
     *
     * @param metaData The CssMetaData instance
