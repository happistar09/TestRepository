    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        rbGroup.selectedToggleProperty().addListener(new ChangeListener<Toggle>(){
            ...
            public void changed(ObservableValue<? extends Toggle> observable, Toggle oldValue, Toggle newValue) {
                /* //how1
                if(newValue == rb1){
                    radioImageView.setImage(new Image(getClass().getResource("images/BubbleChar.png").toString()));
                } else if(newValue == rb2){
                    radioImageView.setImage(new Image(getClass().getResource("images/BarChar.png").toString()));
                } else if(newValue == rb3){
                    radioImageView.setImage(new Image(getClass().getResource("images/AreaChar.png").toString()));
                }
                */
                //how2
                String fileName = newValue.getUserData() +".png";
                radioImageView.setImage(new Image(getClass().getResourceAsStream("images/" + fileName).toString()));
            }           
        });  
    }    
